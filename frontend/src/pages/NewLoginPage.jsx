      ...
      <AuroraBackground>
        <div className="relative z-20 flex flex-col items-center justify-center h-full px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-4 mt-12">
            ...
            <div className="text-xl font-bold text-white mt-2">{user.username}</div>
            <button
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 w-full max-w-xs">
          {!showRegister && (
            <>
              <button
                className="px-4 py-2 rounded-full border border-white/20 text-white bg-black flex items-center gap-2 cursor-pointer w-full justify-center text-lg font-bold"
              ...
              <div className="flex items-center w-full my-2">
                ...
                <span className="mx-3 text-neutral-400 font-semibold">or</span>
                <div className="flex-1 border-t border-neutral-400"></div>
              </div>
              <button
                className="px-4 py-2 rounded-full border border-[#FF971D] text-[#FF971D] bg-white flex items-center gap-2 cursor-pointer w-full justify-center text-lg font-bold mt-2"
                onClick={() => navigate('/dashboard')}
              >
        ...
        <p className="mt-8 text-xs text-neutral-500">
          {!showRegister ? "Select a login method to continue." : "Create your account to join the community."}
        </p>
      </div>
    </AuroraBackground>
  );
