                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm leading-relaxed">
                      ...
                      <p className="mb-2">
                        <span className="text-blue-400">@realDonaldTrump</span>{" "}
                        is in the Epstein files. That is the real reason they
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm leading-relaxed text-gray-800">
                      <p className="mb-2">
                        ...
                        <span className="text-blue-500">@bonk_fun</span> coins
                        on <span className="text-blue-500">@pp_trading</span>{" "}
