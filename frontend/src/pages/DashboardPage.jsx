...
function DashboardPage() {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center h-[100vh] bg-black text-center text-white relative">
        <div
          className="flex justify-center text-4xl md:text-5xl lg:text-6xl font-bold mb-6 mr- ml-5"
        ...
        <div
          className="absolute bottom-36 left-1/2 transform -translate-x-1/2 animate-bounce z-10 cursor-pointer"
          onClick={() => {
            document.querySelector('[class*="statsGrid"]')?.scrollIntoView({
              behavior: "smooth",
            });
          }}
        >
        ...
        <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-b from-transparent to-white z-0"></div>
      </div>
